...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    int temprature = weatherData['main']['temp'].toInt();
...
//                          Text(weatherData['weather'][0]['main'].toString(), style: TextStyle(color: Colors.white, fontSize: 28.0))
          ...
          Padding(
            padding: const EdgeInsets.only(top: 32,left: 20, right: 8.0),
